        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Gallery Edit - {{ $gallery->name }}</h4>
                        ...
                        <form action="{{ route('admin.gallery.update', $gallery->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_ruangan') is-invalid @enderror"
                                    id="nama_ruangan" value="{{ old('nama_ruangan', $gallery->nama_ruangan) }}"
                                    name="nama_ruangan" placeholder="Enter a Nama Ruangan">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tipe') is-invalid @enderror"
                                    id="tipe" value="{{ old('tipe', $gallery->tipe) }}" name="tipe"
                                    placeholder="Enter a Tipe">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi"
                                    placeholder="Enter a Deskripsi">{{ old('deskripsi', $gallery->deskripsi) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('kapasitas') is-invalid @enderror"
                                        id="kapasitas" value="{{ old('kapasitas', $gallery->kapasitas) }}" name="kapasitas"
                            ...
                            <div class="form-group">
                                ...
                                <img class="mt-3 mb-3" src="{{ url('/storage/' . $gallery->gambar) }}">
