        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Rooms Create</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li><a href="{{ route('admin.rooms.index') }}">All Gallerys</a></li>
                        <li><span>Create Rooms</span></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Create New Rooms</h4>
                        ...
                        <form action="{{ route('admin.rooms.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_ruangan') is-invalid @enderror"
                                    ...
                                    placeholder="Enter a Nama Ruangan" autocomplete="off">
                            ...
                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Save Rooms</button>
                        </form>
                    </div>
                </div>
            </div>
